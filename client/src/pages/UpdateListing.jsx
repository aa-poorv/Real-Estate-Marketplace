...
import { getListingData, queryClient, updateListing } from "../utils/http";
...
const CreateListing = () => {
  ...
  const { logoutMutate, logoutPending } = useLogout({ sessionExpired: true });
  ...
  const { mutate, isPending } = useMutation({
    ...
    onError: (err) => {
      if (err.info.message === "jwt expired") {
        ...
        dispatch(statusChangeFlash("Error", err.info.message));
      }
    },
  });
